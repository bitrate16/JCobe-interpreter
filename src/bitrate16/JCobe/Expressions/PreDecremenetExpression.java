...
public class PreDecremenetExpression implements Expression {
	private Expression expression;

	public PreDecremenetExpression(Expression expression) {
	...
	public Value evaluate(Block b) {
		...
		if (expression instanceof ObjectReferenceExpression) {
			...
			ret = e.evaluate(b);
			ret = new PreDecremenetExpression(ret).evaluate(b);
